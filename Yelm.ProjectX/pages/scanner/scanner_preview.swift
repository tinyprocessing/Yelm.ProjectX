    ...
    var body: some View{
        ZStack {
            VStack(alignment: .leading, spacing: 10){
                ...
                Text("Для того чтобы увидеть как будет выглядеть Ваше приложение - отсканируйте QR код, доступный в панели управления")
                ...
                .frame(width: UIScreen.main.bounds.width-70, height: UIScreen.main.bounds.width-70)
